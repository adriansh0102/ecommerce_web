...
import { CartContext } from '@/app/home/cart/contexts/CartContext'
...
export default function Navbar() {
  ...
  const { categorys, isLoading, isError } = useCategoryMenu('category/menu');
                    ...
                    >
                      <div className="p-4">
                        {categorys.data.map((item) => (
                          ...
                          >
                            ...
                            <div className="flex-auto">
                              <a href={`/home/category/${item._id}`} className="block font-semibold text-gray-900">
                                {item.name}
                        ...
                        >
                          ...
                          <div className="flex-auto">
                            <a href={`/home/category`} className="block font-semibold text-gray-900">
                              All
                              <span className="absolute inset-0" />
                            </a>
                            <p className="mt-1 text-gray-600">Explore all Categories</p>
                          </div>
                        </div>
