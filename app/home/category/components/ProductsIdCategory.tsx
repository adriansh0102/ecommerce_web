...
import { useProductGetIdCategory, useProducts } from "@/hooks";
...
export const ProductsCategoryComponent = ({ params }: { params: { id: string } }) => {


  const { products, isLoading, isError } = useProductGetIdCategory(`${params.id}`);
        ...
        isError
          ...
          : isLoading
            ...
            : products.status === 404 || products.status === 500
                ...
                : <div>
                <Title title="All Prsoducts"></Title>
