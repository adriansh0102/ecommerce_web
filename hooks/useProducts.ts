...
export const useProductGetIdCategory = (id: string , config: SWRConfiguration = {}): ResultProductsGetAll => {

  const { data, error, isLoading } = useSWR(`${local}/products/category/${id}`, fetcher , {});
